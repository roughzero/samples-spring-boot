...
import org.mybatis.generator.codegen.mybatis3.MyMyBatis3FormattingUtilities;
...
public class UpdateByPrimaryKeyWithBLOBsElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getPrimaryKeyColumns()) {
            ...
            sb.append(MyBatis3FormattingUtilities.getEscapedColumnName(introspectedColumn));
            sb.append(" = "); //$NON-NLS-1$
            sb.append(MyMyBatis3FormattingUtilities.getParameterClauseInWhereCondition(introspectedColumn));
            answer.addElement(new TextElement(sb.toString()));
        }
